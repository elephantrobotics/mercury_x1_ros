...
void voice_choose_callback(const std_msgs::String& msg)
{
	...
	if(str1 == str2)
	{
		...
		system("aplay -D plughw:CARD=Device,DEV=0 ~/tringai_robot/src/xf_mic_asr_offline/feedback_voice/rplidar_close.wav");
		cout<<"已关闭雷达跟随"<<endl;
	}
	...
	else if(str1 == str3)
	{
		...
		system("aplay -D plughw:CARD=Device,DEV=0 ~/tringai_robot/src/xf_mic_asr_offline/feedback_voice/visual_close.wav");
		cout<<"已关闭色块跟随"<<endl;
	}
	...
	else if(str1 == str4)
	{
		...
		system("aplay -D plughw:CARD=Device,DEV=0 ~/tringai_robot/src/xf_mic_asr_offline/feedback_voice/rrt_close.wav");
	...
	else if(str1 == str5)
	{
		...
		cmdvel_pub.publish(cmd_vel_msg);
		system("dbus-launch gnome-terminal -- roslaunch xf_mic_asr_offline voi_navigation.launch");
		system("aplay -D plughw:CARD=Device,DEV=0 ~/tringai_robot/src/xf_mic_asr_offline/feedback_voice/navigation_close.wav");
		cout<<"已关闭导航"<<endl;
	}
