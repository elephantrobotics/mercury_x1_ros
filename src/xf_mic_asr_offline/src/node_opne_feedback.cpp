...
void laser_follow_flagCallback(std_msgs::Int8 msg)
{
	...
	{
		system("aplay -D plughw:CARD=Device,DEV=0 ~/tringai_robot/src/xf_mic_asr_offline/feedback_voice/rplidar_open.wav");
...
void rrt_flagCallback(std_msgs::Int8 msg)
{
	...
	if(rrt_flag == 1)
	{
		system("aplay -D plughw:CARD=Device,DEV=0 ~/tringai_robot/src/xf_mic_asr_offline/feedback_voice/rrt_open.wav");
		cout<<"自主建图打开成功"<<endl;
	}
...
void visual_follow_flagCallback(std_msgs::Int8 msg)
{
	...
	{
		system("aplay -D plughw:CARD=Device,DEV=0 ~/tringai_robot/src/xf_mic_asr_offline/feedback_voice/visual_open.wav");
		cout<<"色块跟随打开成功"<<endl;
