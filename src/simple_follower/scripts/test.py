...
#Switch = '0:Red\n1:Green\n2:Blue\n3:Yellow\n4:Black'
cv2.createTrackbar('HL','Adjust_hsv',0,180,nothing)
cv2.createTrackbar('SL','Adjust_hsv',0,255,nothing)
cv2.createTrackbar('VL','Adjust_hsv',0,255,nothing)
cv2.createTrackbar('HH','Adjust_hsv',0,180,nothing)
cv2.createTrackbar('SH','Adjust_hsv',0,255,nothing)
cv2.createTrackbar('VH','Adjust_hsv',0,255,nothing)
...
class Follower:
    ...
    def image_callback(self, msg):
        ...
        lowerbH=cv2.getTrackbarPos('HL','Adjust_hsv')
	lowerbS=cv2.getTrackbarPos('SL','Adjust_hsv')
	lowerbV=cv2.getTrackbarPos('VL','Adjust_hsv')
	upperbH=cv2.getTrackbarPos('HH','Adjust_hsv')
	upperbS=cv2.getTrackbarPos('SH','Adjust_hsv')
	upperbV=cv2.getTrackbarPos('VH','Adjust_hsv')
