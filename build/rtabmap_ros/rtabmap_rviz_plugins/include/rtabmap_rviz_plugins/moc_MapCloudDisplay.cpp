...
QT_MOC_LITERAL(9, 169, 13), // "EnumProperty*"
QT_MOC_LITERAL(10, 183, 4), // "prop"
QT_MOC_LITERAL(11, 188, 26), // "setColorTransformerOptions"
QT_MOC_LITERAL(12, 215, 21), // "updateCloudParameters"
QT_MOC_LITERAL(13, 237, 24), // "downloadNamespaceChanged"
QT_MOC_LITERAL(14, 262, 11), // "downloadMap"
QT_MOC_LITERAL(15, 274, 13) // "downloadGraph"
...
QT_INIT_METAOBJECT const QMetaObject rtabmap_rviz_plugins::MapCloudDisplay::staticMetaObject = { {
    &rviz::MessageFilterDisplay<rtabmap_msgs::MapData>::staticMetaObject,
...
void *rtabmap_rviz_plugins::MapCloudDisplay::qt_metacast(const char *_clname)
{
    ...
    return rviz::MessageFilterDisplay<rtabmap_msgs::MapData>::qt_metacast(_clname);
}

int rtabmap_rviz_plugins::MapCloudDisplay::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = rviz::MessageFilterDisplay<rtabmap_msgs::MapData>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 12)
