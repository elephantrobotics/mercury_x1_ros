...
struct WorldCanvas_
{
  ...
  _description_type description;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _geometry_type;
...
struct Printer< ::world_canvas_msgs::WorldCanvas_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::world_canvas_msgs::WorldCanvas_<ContainerAllocator>& v)
  {
    ...
    s << indent << "geometry: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.geometry);
  }
};
