...
struct SaveAnnotationsDataRequest_
{
  ...
  _annotations_type annotations;
   ...
   typedef std::vector< ::world_canvas_msgs::AnnotationData_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::world_canvas_msgs::AnnotationData_<ContainerAllocator> >> _data_type;
  _data_type data;
