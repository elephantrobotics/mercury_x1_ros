...
struct PubAnnotationsDataRequest_
{
  ...
  _topic_name_type topic_name;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _topic_type_type;
...
struct Printer< ::world_canvas_msgs::PubAnnotationsDataRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::world_canvas_msgs::PubAnnotationsDataRequest_<ContainerAllocator>& v)
  {
    ...
    s << indent << "topic_type: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.topic_type);
