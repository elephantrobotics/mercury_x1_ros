...
if("TRUE" STREQUAL "TRUE")
  set(xf_mic_asr_offline_SOURCE_PREFIX /home/er/mercury_x1_ros/src/xf_mic_asr_offline)
  set(xf_mic_asr_offline_DEVEL_PREFIX /home/er/mercury_x1_ros/devel)
  ...
  set(xf_mic_asr_offline_INSTALL_PREFIX /home/er/mercury_x1_ros/install)
...
if(NOT "/home/er/mercury_x1_ros/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xf_mic_asr_offline' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/er/mercury_x1_ros/src/xf_mic_asr_offline/${idir}'.  ${_report}")
    endif()
