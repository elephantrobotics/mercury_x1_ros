...
(cl:defmethod cl:initialize-instance :after ((m <Metadata>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Metadata)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orbbec_camera-msg:<Metadata> is deprecated: use orbbec_camera-msg:Metadata instead.")))
...
(cl:defmethod json_data-val ((m <Metadata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orbbec_camera-msg:json_data-val is deprecated.  Use orbbec_camera-msg:json_data instead.")
  (json_data m))
