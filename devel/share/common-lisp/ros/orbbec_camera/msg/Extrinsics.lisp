...
(cl:defmethod cl:initialize-instance :after ((m <Extrinsics>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Extrinsics)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orbbec_camera-msg:<Extrinsics> is deprecated: use orbbec_camera-msg:Extrinsics instead.")))
...
(cl:defmethod rotation-val ((m <Extrinsics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orbbec_camera-msg:rotation-val is deprecated.  Use orbbec_camera-msg:rotation instead.")
  (rotation m))

(cl:ensure-generic-function 'translation-val :lambda-list '(m))
(cl:defmethod translation-val ((m <Extrinsics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orbbec_camera-msg:translation-val is deprecated.  Use orbbec_camera-msg:translation instead.")
  (translation m))
