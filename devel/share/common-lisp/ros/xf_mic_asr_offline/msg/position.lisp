...
(cl:defmethod cl:initialize-instance :after ((m <position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline-msg:<position> is deprecated: use xf_mic_asr_offline-msg:position instead.")))

(cl:ensure-generic-function 'angleX-val :lambda-list '(m))
(cl:defmethod angleX-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline-msg:angleX-val is deprecated.  Use xf_mic_asr_offline-msg:angleX instead.")
  (angleX m))

(cl:ensure-generic-function 'angleY-val :lambda-list '(m))
(cl:defmethod angleY-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline-msg:angleY-val is deprecated.  Use xf_mic_asr_offline-msg:angleY instead.")
  (angleY m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline-msg:distance-val is deprecated.  Use xf_mic_asr_offline-msg:distance instead.")
  (distance m))
